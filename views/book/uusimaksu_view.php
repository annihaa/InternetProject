...
<article>
<h2>Valitse tili tästä:</h2>

<div class="dropdown">
  <button class="dropbtn">Valitse maksutili</button>
  <div class="dropdown-content">
    <a href="../controllers/maksutili1.php">Käyttötili</a>
    <a href="../controllers/maksutili2.php">Taloustili</a>
    <a href="../controllers/maksutili3.php">Säästötili</a>
  </div>
</div>
</article>
<br><br><br>
